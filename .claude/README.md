...
pos: .claude/
input: 无
output: AI 系统配置（规则/命令/技能）
update: 新增规则/命令/技能时更新此 README + 文件变更时同步更新文件头
---
...
| `06-NOW.md` | P0 | 会话启动流程 |
| `WORK.md` | P1 | 工作手册 |
| `FIVE-FILE-WORKFLOW.md` | P1 | 五文件工作流指南 |
| `README.md` | P1 | 规则库说明（本文档） |
...
| `UPDATE_MEMORY.md` | `/UPDATE_MEMORY` | 每周记忆整理 |
| `plan.md` | `/plan` | 五文件工作流 |
